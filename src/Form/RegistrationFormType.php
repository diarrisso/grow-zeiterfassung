...
class RegistrationFormType extends AbstractType
{
    public function buildForm(FormBuilderInterface $builder, array $options): void
    {
        ...
        ->add('vorname', TextType::class, array('label' => false, 'attr' => array('placeholder' => 'Vorname')))
        ->add('nachname', TextType::class, array('label' => false, 'attr'=> array('placeholder' => 'Nachname')))
